...
Public Class Class1
    Public Function Loadkhachang() As DataSet
        Dim chuoiketnoi As String = "workstation id=ps03128.mssql.somee.com;packet size=4096;user id=huyps03128;pwd=huy@123asd;data source=ps03128.mssql.somee.com;persist security info=False;initial catalog=ps03128"
